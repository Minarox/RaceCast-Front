/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7080c74d39653ccad8a8b10575358379)
// Runtime types generated with workerd@1.20251001.0 2025-10-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		LIVEKIT_ROOM: string;
		LIVEKIT_REMOTE_IDENTITY: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIVEKIT_DOMAIN" | "LIVEKIT_API_KEY" | "LIVEKIT_API_SECRET" | "LIVEKIT_ROOM" | "LIVEKIT_REMOTE_IDENTITY">> {}
}
